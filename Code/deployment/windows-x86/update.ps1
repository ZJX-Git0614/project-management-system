...
function Ensure-CompatibleSystemBackupConfiguration([string]$Directory) {
  ...
  $backupPath = "$composePath.before-update-20260728-5"
...
$rollbackImage = "ceastar-project-management:rollback-20260728-5-amd64"
...
Set-Content -Path (Join-Path $deploymentDirectory ".ceastar-update-20260728-5.state") -Value $state -Encoding ASCII
