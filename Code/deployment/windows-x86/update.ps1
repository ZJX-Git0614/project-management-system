...
function Ensure-CompatibleSystemBackupConfiguration([string]$Directory) {
  ...
  $backupPath = "$composePath.before-update-20260729-3"
...
$rollbackImage = "ceastar-project-management:rollback-20260729-3-amd64"
...
Set-Content -Path (Join-Path $deploymentDirectory ".ceastar-update-20260729-3.state") -Value $state -Encoding ASCII
