...
add_code(doc, "D:\\PMS\\Ceastar-PMS-内网完整部署-20260723\\docker-compose.yml\nD:\\PMS\\Ceastar-PMS-内网完整部署-20260723\\Ceastar-PMS-Update-20260730-1\\update.bat")
...
add_callout(
    doc,
    "MPP 导出服务说明",
    "更新脚本不会自动启动 Microsoft Project 或注册 MPP 导出服务，避免 Project 自动化或权限窗口阻塞更新。系统更新完成后，如确实需要导出二进制 MPP 文件，再右键以管理员身份运行 repair-mpp-export-service.bat。Excel 和 Project XML 导出不受影响。",
)
...
doc.core_properties.subject = "Ceastar PMS 2026.07.30.1 离线更新操作说明"
