    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { key: "project-deliverables:export", label: "导出交付物清单", type: "action" },
          { key: "project-delivery-status:view", label: "查看交付物状态", type: "section" },
          { key: "project-delivery-status:edit", label: "编辑交付物状态资料", type: "action" },
          { key: "project-delivery-status:status-change", label: "变更交付物状态", type: "action" },
          { key: "project-delivery-status:upload-material-list", label: "登记物料清单版本", type: "action" },
          { key: "project-delivery-status:publish-material-revision", label: "发布物料清单版本", type: "action" },
        ],
      },
      {
        ...
        children: [
          ...
          { key: "project-procurement:sync-bom", label: "同步 BOM 到采购", type: "action" },
          { key: "project-procurement:status-change", label: "变更采购状态", type: "action" },
        ],
      },
    ],
  },
...
export const DEFAULT_PERMISSION_TREE: PermissionTreeState = {
  ...
  "项目经理": [
    ...
    ...allNodeKeysFor("project-deliverables"),
    ...allNodeKeysFor("project-procurement"),
  ...
  "项目成员": [
    ...
    "project-delivery-status:view",
    "project-delivery-status:edit",
    "project-delivery-status:status-change",
    "project-delivery-status:upload-material-list",
    "project-delivery-status:publish-material-revision",
    "project-procurement",
    "project-procurement:view",
    "project-procurement:create",
    "project-procurement:edit",
    "project-procurement:sync-bom",
    "project-procurement:status-change",
    "project-risk",
    "risk-register",
    "risk-register:view",
