...
$rollbackImage = "ceastar-project-management:rollback-20260727-amd64"
...
Set-Content -Path (Join-Path $deploymentDirectory ".ceastar-update-20260727.state") -Value $state -Encoding ASCII
