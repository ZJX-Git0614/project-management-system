...
$rollbackImage = "ceastar-project-management:rollback-20260724-amd64"
...
Set-Content -Path (Join-Path $deploymentDirectory ".ceastar-update-20260724.state") -Value $state -Encoding ASCII
